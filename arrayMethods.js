...
// CODE HERE
const totalPopulation = populations.reduce((sum, add) => sum + add)
...
// CODE HERE
const newTot = orders.map(obj => obj.price + (obj.price * obj.tax))
console.log(newTot)
...
// CODE HERE
let bobsTotal = purchases.filter(obj => obj.owner === 'Bob').reduce((sum, add) => sum + add.price, 0)
